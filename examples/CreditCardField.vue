<template>
    <div id="app" class="container">
        <h1>credit-card-field</h1>

        <h3>Overview</h3>

        <p>
            This component is meant to be a standalone Vue component that attempts
            to provide a credit card UI that improves conversions from other
            fields.
        </p>
